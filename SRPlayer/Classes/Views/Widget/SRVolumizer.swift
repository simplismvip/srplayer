...
//    
//    @discardableResult
//    open class func configure(_ options: [VolumizerAppearanceOption] = []) -> SRVolumizer {
...
//        
//        let instance = SRVolumizer(options: options, base: base)
...
//        do {
//            try session.setCategory("", mode: "", options: .mixWithOthers)
//        }
